...
export default class GovRadioButtons extends LightningElement {
    ...
    get questionLabelClass() {
        ...
        switch(this.questionFontSize.toLowerCase()) {
            case "small":
                questionLabelClass = "ds_label ds_label--s";
                break;
            case "medium":
                questionLabelClass = "ds_label ds_label--m";
                break;
            case "large":
                questionLabelClass = "ds_label ds_label--l";
                break;
            default:
                questionLabelClass = "ds_label ds_label--s";
        }
    ...
    get radioClass() {
        let radioClass = "ds_radio";
        radioClass = (this.inlineRadios) ? radioClass + " ds_radio--inline" : radioClass;
        radioClass = (this.smallerRadios) ? radioClass + " ds_radio--small" : radioClass;
        return radioClass;
    }
