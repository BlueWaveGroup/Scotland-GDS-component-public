/**
 * Component Name: Gov Warning Text
...
@api regexPattern = '';
@api visibilityValue = '';
@api selectedValuesForCheck='';//to remove
...
get labelClass() {
    ...
    switch(this.fontSize) {
        case "Small":
            labelClass = "ds_label ds_small";
            break;
        case "Medium":
            labelClass = "ds_label ds_medium";
            break;
        case "Large":
            labelClass = "ds_label ds_large";
            break;
        default:
            labelClass = "ds_label ds_small";
    }
